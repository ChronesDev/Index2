...
inline Index::Func<void()> OnRender;
inline Index::Vec2F WindowSize;
...
inline int Entry()
{
    ...
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, "Dear ImGui DirectX9 Example", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
